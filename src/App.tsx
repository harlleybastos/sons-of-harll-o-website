...
const App: React.FC = () => {
  return (
    <MainContainer>
      ...
      <div
        id="home"
        className="relative flex items-center justify-center overflow-hidden bg-primary pt-[140px] md:pt-[150px] lg:pt-[180px]"
      >
        <div className="container max-w-full">
          <div className="relative z-10 wow fadeInUp" data-wow-delay=".25s">
            <img src={JaxTeller} alt="hero" className="rounded-t-xl" />
          </div>
        </div>
      </div>
