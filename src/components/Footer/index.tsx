...
const Footer = () => {
  return (
    ...
    >
      <div className="flex flex-wrap text-center">
        <div className="w-full px-4 ">
          ...
          <p className="mb-7 text-base text-[#f3f4fe]">
            Nossa missão: Jamais deixar o brilho de SAMCRO de apagar !
          </p>
          <div className="-mx-3 flex items-center text-center justify-center">
            <a
      ...
      <div className="mt-12 border-t border-opacity-40 py-8 lg:mt-[60px] text-center">
        <div className="w-full px-4">
          <p className="text-base text-[#f3f4fe]">
            Developed by Harlley Bastos 🚀
          </p>
        </div>
      </div>
    </footer>
