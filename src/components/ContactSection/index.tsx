...
const ContactSection = () => {
  return (
    <section
      id="contact"
      className="relative py-20 md:py-[120px] flex justify-center bg-[#f3f4fe]"
    >
      <div className="absolute top-0 left-0 z-[-1] h-1/2 w-full  lg:h-[45%] xl:h-1/2"></div>
